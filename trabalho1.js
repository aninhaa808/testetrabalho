...
const filmes=['Gente Grande','Star wars','Harry Poter']
...
let nomes = ["relampago maqueen", "chaves", "patrick estrela"]
let forcas = [180, 195, 140]
console.log(personagensFortes(nomes, forcas))
